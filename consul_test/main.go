...
func Register(address string, port int, name string, tags []string, id string) error {
	...
	check := &api.AgentServiceCheck{
		HTTP:                           "http://172.18.0.1:9023/health",
		Timeout:                        "5s",
		Interval:                       "1s",
...
func main() {
	// _ = Register("127.0.0.1", 9023, "user_web", []string{"user_web", "lee"}, "user_web")
	// _ = Register("172.18.0.1", 9023, "user_web", []string{"user_web", "lee"}, "user_web")
