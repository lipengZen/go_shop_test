...
func (x *HelloRequest) GetClasses() []string {
	if x != nil {
		return x.Classes
	}
	return nil
...
var file_helloworld_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x12, 0x0a, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x77, 0x6f, 0x72, 0x6c, 0x64, 0x22, 0x4e,
	...
	0x03, 0x61, 0x67, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x63, 0x6c, 0x61, 0x73, 0x73, 0x65, 0x73, 0x18,
	0x03, 0x20, 0x03, 0x28, 0x09, 0x52, 0x07, 0x63, 0x6c, 0x61, 0x73, 0x73, 0x65, 0x73, 0x22, 0x20,
	...
	0x6c, 0x6f, 0x12, 0x18, 0x2e, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x77, 0x6f, 0x72, 0x6c, 0x64, 0x2e,
	0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x14, 0x2e, 0x48,
	0x65, 0x6c, 0x6c, 0x6f, 0x77, 0x6f, 0x72, 0x6c, 0x64, 0x2e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x42, 0x0f, 0x5a, 0x0d, 0x2e, 0x2f, 0x3b, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x77, 0x6f,
...
var file_helloworld_proto_depIdxs = []int32{
	0, // 0: Helloworld.Hello.Hello:input_type -> Helloworld.HelloRequest
	1, // 1: Helloworld.Hello.Hello:output_type -> Helloworld.Response
...
func (c *helloClient) Hello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/Helloworld.Hello/Hello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Hello_Hello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Helloworld.Hello/Hello",
	}
